ann_file = '/home/theo2204/python-workspace/openmmlab-repo/mmaction2_shuffle_stgcn/mmaction/datasets/ntu60_2d.pkl'
...
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=dict(
            ann_file=
            '/home/theo2204/python-workspace/openmmlab-repo/mmaction2_shuffle_stgcn/mmaction/datasets/ntu60_2d.pkl',
            pipeline=[
                dict(type='PreNormalize2D'),
                dict(dataset='coco', feats=[
                    'j',
...
work_dir = '/home/theo2204/python-workspace/openmmlab-repo/mmaction2_shuffle_stgcn/mmaction/training_space/exp01'
